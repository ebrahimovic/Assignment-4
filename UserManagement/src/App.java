    ...
    public static void showUserMenu() {
        ...
        do {
            ...
            switch (userSelected) {
                ...
                sc.nextLine(); 
                User userToUpdate = userController.getUserById(idToUpdate);
                 if (userToUpdate == null) {
                System.out.println("User with ID " + idToUpdate + " does not exist");
                break;
                }
                System.out.println("Enter User Name: ");
                ...
                System.out.println("Enter User Password: ");
                String updatedUserPassword = sc.nextLine();

                System.out.println("Enter User age: ");
                int updatedUserAge = sc.nextInt();

                User updatedUser = new User(updatedUserName, updatedUserEmail, updatedUserPassword, updatedUserAge);
